    ...
    <div className="recipe-profile-container">
      <div className="recipe-profile-name">
        ...
        <div className="recipe-profile-btn-div">
          <button className="recipe-profile-btn capitalize-first-letter">Similar Recipes</button>
          <button className="recipe-profile-btn capitalize-first-letter">Start Making</button>
        </div>
      </div>
